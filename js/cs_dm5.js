...
var bindListener, findEachUrl, findUrl, isValidPath, menuUri, nextUri, prevUri, setHotkeyPanel, setImage, setLikeButton, setNavButton,
...
findUrl = function() {
  var cid, episodeNumber, i, imageList, max, re_cid, title, _i, _results;
  re_cid = /m(\d+)/;
